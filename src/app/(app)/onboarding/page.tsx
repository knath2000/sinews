...
export default function OnboardingPage() {
  ...
  if (success) {
    return (
      <div className="flex min-h-full flex-1 items-center justify-center px-4 py-12 sm:px-6 lg:px-8 bg-zinc-50">
        <div className="w-full max-w-2xl space-y-8 bg-white p-8 rounded-2xl shadow-lg text-center">
          <div className="mx-auto w-16 h-16 rounded-full bg-green-100 flex items-center justify-center">
            <svg
              className="w-8 h-8 text-green-600text-green-400"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <h2 className="text-2xl font-semibold text-blacktext-zinc-50">
            Welcome aboard!
          </h2>
  ...
  return (
    <div className="min-h-full bg-zinc-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <form onSubmit={handleSubmit}>
          {/* Topic Grid */}
          <fieldset>
            <legend className="text-sm font-medium text-zinc-700 mb-4">
                  ...
                  <button
                    ...
                    className={`flex items-center rounded-lg border px-4 py-3 text-sm font-medium transition-all ${
                      isSelected
                        ...
                        : "border border-zinc-300 text-zinc-700 hover:border-zinc-400 bg-white"
                    }`}
                  >
                    <span
          ...
          <div className="mt-8">
            ...
            <select
              ...
              required
              className="block w-full rounded-lg border border-zinc-300 bg-white px-4 py-3 text-zinc-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
            >
